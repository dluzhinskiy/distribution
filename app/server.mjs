...
import { readData, saveData, storagePath, storageStatus } from "./lib/excel-store.mjs";
...
async function api(req, res, url) {
  ...
  if (req.method === "GET" && url.pathname === "/api/data") {
    ...
    return sendJson(res, 200, {
      ...
      storageStatus: await storageStatus(),
      directoriesPath: directoriesPath(),
    });
  }

  if (req.method === "GET" && url.pathname === "/api/storage-status") {
    return sendJson(res, 200, { ok: true, storageStatus: await storageStatus() });
  }
