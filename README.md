...
- Для сотрудника без пароля доступна кнопка «Выдать код». Если пароль был установлен и доступ утрачен, используйте «Сбросить пароль»: после подтверждения старый пароль и все сессии отменяются, а новый код показывается один раз.
