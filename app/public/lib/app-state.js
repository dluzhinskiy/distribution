export function createAppState() {
  return {
    ...
    dirtyViews: new Set(["dashboard", "distribution", "cases", "employees", "settings"]),
    loadedViews: new Set(),
    ...
    casesPage: 1,
    casesPageSize: 150,
    casesSearchTimer: null,
    caseRegistryRows: [],
    caseRegistryTotal: 0,
    caseRegistryTotalPages: 1,
    caseRegistryLoaded: false,
    caseRegistryLoading: false,
    caseRegistryRequestId: 0,
    caseListScope: "yuc",
