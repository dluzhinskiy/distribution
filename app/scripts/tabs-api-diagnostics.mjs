...
const tables = [
  ...
  },
  {
    ...
    createFields: (stamp) => ({
      employee_id: `DIAG-EMP-${stamp}`,
      "ФИО": `Диагностика API ${stamp}`,
      "Дата начала": Date.now(),
      "Дата окончания": Date.now(),
      "Тип": "Отпуск",
      "Комментарий": "Создано диагностикой. Запись должна быть удалена автоматически.",
  ...
  },
  {
    ...
    createFields: (stamp) => ({
      "ЮЦ": "Дальний Восток",
      "Регион": "Иркутская область",
      "Основной сотрудник": `Диагностика API ${stamp}`,
      "Замещающий сотрудник": `Диагностика API замещение ${stamp}`,
      "Тип нагрузки": "судебное",
      "Активно": "Нет",
      "Комментарий": "Создано диагностикой. Запись должна быть удалена автоматически.",
    }),
