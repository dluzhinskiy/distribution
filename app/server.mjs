...
import { allDatesInRange, assignAutomatically, assignExistingAutomatically, assignExistingManually, assignManually, clearVacationYear, enrichData, normalizeDraft, recommend, setVacationDates, toISODate } from "./lib/domain.mjs";
...
const HOST = process.env.HOST || (process.env.RAILWAY_ENVIRONMENT || process.env.RAILWAY_PROJECT_ID || process.env.CODESPACES ? "0.0.0.0" : "127.0.0.1");
